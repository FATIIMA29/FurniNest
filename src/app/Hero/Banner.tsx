...
const slides = [
  {
    ...
    buttonText: "Shop Now",
    chairImage: "/images/herochair.png", // Replace with the correct path
    lampImage: "/images/herolamp.png", // Replace with the correct path
  },
  {
  ...
  return (
    <section className="relative bg-gray-100 py-10 md:py-20 px-5 md:px-20 flex flex-col md:flex-row items-center justify-between overflow-hidden">
      ...
      <div className="md:w-1/4 flex justify-center items-start relative">
        <div className="absolute top-[-350px] left-[-40px] z-10">
          <Image
            ...
            width={387}
            height={387}
            className="object-contain w-full max-w-[387px] h-auto"
          />
        </div>
      </div>
      ...
      <div className="md:w-1/3 flex justify-center items-center relative">
        <div className="relative bg-gradient-to-r from-pink-100 to-purple-200 rounded-full p-10 shadow-xl mt-10 mx-auto md:mt-0">
          <Image
            src={current.chairImage}
            alt="Furniture Chair"
            width={706}
            height={689}
            className="object-contain w-full max-w-[706px] h-auto"
          />
        </div>
      </div>
